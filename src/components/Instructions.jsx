      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto">
          {instructions.map((instruction, index) => (
            <div
              key={index}
              className="flex items-start mb-8 p-6 bg-gray-50 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow duration-300"
            >
              ...
              <p className="text-gray-700 leading-relaxed pt-1 font-medium text-lg">
                {instruction.text}
              </p>
            </div>
          ))}
